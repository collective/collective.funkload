...
_funkload_init.orig = FunkLoadTestCase.FunkLoadTestCase._funkload_init

def patch():
    FunkLoadTestCase.FunkLoadTestCase._funkload_init = _funkload_init

def unpatch():
    FunkLoadTestCase.FunkLoadTestCase._funkload_init = (
        _funkload_init.orig)
